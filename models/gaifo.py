"""
Adapted from https://github.com/dwjshift/IL_ADS/blob/4e478b802dca280bd3efa731eb4f11941329f659/IL/agent/gaifo.py
"""
import numpy as np
...
class GAIfOAgent:
	def __init__(self, obs_shape, action_shape, device, lr, feature_dim,
				 ...
				 augment, use_actions, suite_name, obs_type, name,
				 expl_noise, update_policy_freq):
		self.device = device
		self.lr = lr
