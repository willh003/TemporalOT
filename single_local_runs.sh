...
# Training Parameters
TASK_NAME="button-press-v2" # ("button-press-v2" "door-close-v2"  "window-open-v2" "stick-push-v2" "lever-pull-v2" "door-open-v2")
REWARD_FN="roboclip" 
SEED="r"
...
# Roboclip Parameters
CONTEXT_NUM=1
# - No changes to "use_encoder" since obs_type="features"
# End of Roboclip Parameters
